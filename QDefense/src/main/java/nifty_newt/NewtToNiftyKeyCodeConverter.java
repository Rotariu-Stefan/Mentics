...
/**
 * Convert awt key codes to nifty key codes, based on lwjgl <a href=
 * "http://java-game-lib.svn.sourceforge.net/viewvc/java-game-lib/trunk/LWJGL/src/java/org/lwjgl/opengl/KeyboardEventQueue.java?revision=3116&content-type=text%2Fplain"
 * >code</a>.
 * 
 * @author acoppes
 * 
...
class NewtToNiftyKeyCodeConverter {
    ...
    public int convertToNiftyKeyCode(int key_code) {
        ...
        case KeyEvent.VK_WINDOWS: // fall through
    ...
    /*public int convertToNiftyKeyCode(int key_code, int location) {
        ...
        case KeyEvent.VK_ALT: // fall through
            if (location == KeyEvent.KEY_LOCATION_RIGHT) return KeyboardInputEvent.KEY_RMENU;
            else return KeyboardInputEvent.KEY_LMENU;
        case KeyEvent.VK_WINDOWS:
        case KeyEvent.VK_META:
            if (location == KeyEvent.KEY_LOCATION_RIGHT) return KeyboardInputEvent.KEY_RMETA;
            else return KeyboardInputEvent.KEY_LMETA;
        case KeyEvent.VK_SHIFT:
            if (location == KeyEvent.KEY_LOCATION_RIGHT) return KeyboardInputEvent.KEY_RSHIFT;
            else return KeyboardInputEvent.KEY_LSHIFT;
        case KeyEvent.VK_CONTROL:
            if (location == KeyEvent.KEY_LOCATION_RIGHT) return KeyboardInputEvent.KEY_RCONTROL;
            else return KeyboardInputEvent.KEY_LCONTROL;
        default:
            return KEY_MAP[key_code];
        }
    }*/
